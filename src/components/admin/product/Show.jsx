					...
					<div className="col-md-9">
						<div className="card shadow">
                            <div className="card-body p-4">
                                ...
                                {
                                    loader == false && products.length == 0 && <Nostate text='There is no data to display of products !'/>
                                }
                                                ...
                                                products.map(product => {
                                                    return (
                                                        <tr key={`product-${product.id}`}>
                                                            <td>{product.id}</td>
                                                            <td>
                                                                <img src={product.image_url} alt="" width={45} />
                                                            </td>
                                                            <td>{product.title}</td>
                                                            <td>{product.price}</td>
                                                            <td>{product.qty}</td>
                                                            ...
                                                            <td>
                                                                {
                                                                    ...
                                                                    : <span className='badge text-bg-dark'>Block</span>
                                                                }
